...
ipcRenderer.on(NOTIFICATION_SERVICE_STARTED, (_, token) => {
  ...
  var elem = document.getElementById("fcm-token");
...
// Start service
const senderId = process.env.SENDER_ID; // <-- replace with FCM sender ID from FCM web admin under Settings->Cloud Messaging
console.log("starting service and registering a client");
console.log("process.env.SENDER_ID", JSON.stringify(process.env, null, 2));
